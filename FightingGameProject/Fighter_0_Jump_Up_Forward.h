...
namespace RB
{
	...
	public:
		Fighter_0_Jump_Up_Forward()
		{
			...
			animationController.SetColliderFile("BoxColliderData/Fighter_0/fighter_0_jump_up_forward.collider");
		...
		void OnEnter(ObjData& objData, GameData& gameData) override
		{
			...
			objData.ptrJumpProcessor->SetSideForce(5);
		...
		void OnUpdate(ObjData& objData, GameData& gameData) override
		{
			...
			else if (objData.ptrJumpProcessor != nullptr)
			{
				...
				{
					nextState = State::NewState<Fighter_0_Jump_Fall>(nullptr, nullptr);
				}
			}
